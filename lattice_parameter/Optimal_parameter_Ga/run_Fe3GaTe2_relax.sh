...
a1=$(awk "BEGIN {printf \"%.6f\", 4.142245 * $scale}")
a2=$(awk "BEGIN {printf \"%.6f\", -2.0711225 * $scale}")
a3=$(awk "BEGIN {printf \"%.6f\", 3.587289 * $scale}")

subdir="./ratio_$latt"
mkdir -p "$subdir"

cat > Fe3GaTe2_relax.fdf <<END

# FDF file for Fe3GaTe2 

# General System descriptors

SystemName Fe3GaTe2                  # Descriptive name of the system
SystemLabel Fe3GaTe2_relax           # Short name for naming files
...
MeshCutoff              1200 Ry     # Equivalent planewave cutoff for the grid10
