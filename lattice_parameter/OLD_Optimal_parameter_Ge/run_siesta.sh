#!/bin/bash
#SBATCH --job-name=Fe3GeTe2   # this is just a name, it will be shown in the queue handler. Makes it easier to 
...
#SBATCH --time=04:00:00       # important too tune. After this amount of time the job is killed. Format: hh:mm:ss. Max 5 days.
...
time srun /project/p_trildft/bin/siesta < Fe3GeTe2_relax.fdf > output.out
